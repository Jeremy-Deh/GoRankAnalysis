...
Yet, since the last change in the FFG algorithm occured in 2012, a major technology shook the world of Go, with the arrival of AI. Such technology in Go changed for good the way we play Go, and it is now time to adapt to the recent changes and take advantage of it to improve our ranking system and get really close to a uniformed and reliable ranking system.
